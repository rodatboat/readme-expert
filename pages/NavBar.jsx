...
export default function NavBar({ preview, togglePreview, downloadFile }) {
    ...
    const DLIcon = () => {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" onClick={downloadFile} className="icon icon-tabler icon-tabler-download hover:bg-primary-light rounded-full p-1 border border-2 border-primary-light" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#fff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <nav className="h-full w-full">
            <div className="flex flex-row sticky top-0 items-center justify-between h-full p-2 bg-primary">
                <div className="flex items-center">
                    <img src={imgUrl} className="max-h-24" width="auto" height="96" alt="readme.expert logo" />
                </div>
