  ...
  return (
    <>
      <NavWrapper togglePreview={togglePreview} preview={preview} downloadFile={downloadFile} >
        <div className="flex flex-auto mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 overflow-hidden">
          <div className="flex flex-col flex-auto md:flex-row md:gap-x-4 md:gap-y-0">
            <div className={`relative flex-auto basis-1/2 rounded-xl overflow-y-scroll scrollbar-hide ${preview ? "hidden" : "block"} md:block border-2 border-primary bg-secondary`}>
