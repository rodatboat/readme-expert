    ...
    <>
      <NavWrapper togglePreview={togglePreview} preview={preview} downloadFile={downloadFile} >
        <div className="flex flex-initial mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6 overflow-hidden">
          <div className="flex flex-col flex-initial md:flex-row md:gap-x-4 md:gap-y-0">
            <div className={`relative flex-1 basis-1/2 max-w-full overflow-x-hidden rounded-xl overflow-y-scroll scrollbar-hide ${preview ? "hidden" : "block"} md:block border-2 border-primary bg-secondary`}>
            ...
            <div className={`relative flex-1 basis-1/2 max-w-full overflow-x-hidden rounded-xl overflow-y-scroll scrollbar-hide ${preview ? "block" : "hidden"} md:block border-2 border-primary bg-secondary`}>
              <p className="z-50 sticky top-0 flex-1 rounded-t-xl text-sm py-1 font-bold text-center text-[#fff] bg-secondary border-2 border-l-0 border-r-0 border-t-0 border-b-1 border-primary uppercase">
                Preview
              </p>
