    ...
    <>
      <div className="flex flex-col max-h-screen h-screen overflow-auto">
        <div className="flex-1 flex flex-col items-center justify-center my-auto gap-5 max-w-xl text-center mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-6">
          <h2></h2>
          <h1 className="text-[#fff] font-black text-5xl md:text-6xl">readme<span className="text-primary">.expert</span></h1>
          <p className="text-[#fff] text-md md:text-lg">Simplify the process of creating and previewing markdown files. Share code snippets with other developers.</p>
          <a href="/e">
